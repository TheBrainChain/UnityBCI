...
//	}
	...
	{
		Process.Start ("C:\\Users\\ChristopherCoogan\\Documents\\BCI2000\\batch\\VRCopy.bat");
	}
	...
	void Update()
	{
		...
		if (TargetCode == 1) 
		{
			...
			transform.position = new Vector3(CursorPosX/80, 13, 32);
			if (ResultCode == 1)
			{
		...
		if (TargetCode == 0)
		{
			...
			Destroy (LeftClone);
			Destroy (RightClone);
			transform.position = new Vector3 (0, 13, 32);
		}
